...
(function() {
    ...
    function onDeviceReady() {
        ...
        client = new WindowsAzure.MobileServiceClient('https://charlesehh.azurewebsites.net');
    ...
    function syncBackend() {
        ...
        //Pull items from tge Azure table after syncing to Azure.
